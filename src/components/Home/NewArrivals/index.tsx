      ...
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="mb-7 flex items-center justify-between">
          ...
          <Link
            ...
            className="inline-flex font-medium text-custom-sm py-2.5 px-7 rounded-md border-gray-3 dark:border-slate-700 border bg-gray-1 dark:bg-slate-800 text-dark dark:text-white ease-out duration-200 hover:bg-dark dark:hover:bg-blue hover:text-white hover:border-transparent"
          >
            View All
          </Link>
        </div>
