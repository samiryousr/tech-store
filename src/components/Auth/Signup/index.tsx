          ...
          <div className="max-w-[390px] w-full mx-auto rounded-xl bg-white shadow-1 p-3 sm:p-5">
            ...
            <div>
              <form>
                ...
                <div className="mb-3">
                  <label htmlFor="re-type-password" className="block mb-1.5 text-sm">
                ...
                <button
                  type="submit"
                  className="w-full flex justify-center font-medium text-sm text-white bg-dark py-2 px-4 rounded-lg ease-out duration-200 hover:bg-blue mt-5"
                >
                  Create Account
                </button>
