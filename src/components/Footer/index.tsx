...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            <h2 className="mb-7.5 text-custom-1 font-semibold text-dark dark:text-white">
              Help & Support
            </h2>
          ...
          <div className="w-full sm:w-auto">
            <h2 className="mb-7.5 text-custom-1 font-semibold text-dark dark:text-white lg:text-right">
              Download App
            </h2>

            <p className="lg:text-right text-custom-sm mb-4 text-dark-4 dark:text-slate-400">
      ...
      {/* <!-- footer bottom start --> */}
      <div className="py-5 xl:py-7.5 bg-gray-1 dark:bg-[#070b14] border-t border-transparent dark:border-slate-800/80">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark dark:text-slate-400 font-medium">
