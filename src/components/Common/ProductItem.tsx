...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  // i hate myself what i suppose to do i can't move on 
  // i see thats so big to take this major it's not for me
  // what i can do exept this i 'll fuck my hole life it's alraedy fucked
